...
ECha_Main:	; Routine 0
		cmpi.b	#2,(o_player+obFrame).w ; this isn't `fr_Wait1`: `o_player` is Object 88, which has its own frames
...
ECha_CreateEms:
		move.w	(o_player+obX).w,obX(a0) ; match X position with Sonic
		move.w	(o_player+obY).w,obY(a0) ; match Y position with Sonic
		movea.l	a0,a1
		moveq	#0,d3
		moveq	#1,d2
		moveq	#5,d1
