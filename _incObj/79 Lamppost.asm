...
Lamp_StoreInfo:
		...
		move.b	(v_lastlamp).w,(v_lamp_last).w
		...
		move.w	(v_bgscreenposx).w,(v_lamp_bgx).w ; bg position
		move.w	(v_bgscreenposy).w,(v_lamp_bgy).w 	; bg position
		move.w	(v_bg2screenposx).w,(v_lamp_bg2x).w 	; bg position
		move.w	(v_bg2screenposy).w,(v_lamp_bg2y).w 	; bg position
		move.w	(v_bg3screenposx).w,(v_lamp_bg3x).w 	; bg position
		move.w	(v_bg3screenposy).w,(v_lamp_bg3y).w 	; bg position
...
Lamp_LoadInfo:
		move.b	(v_lamp_last).w,(v_lastlamp).w
		move.w	(v_lamp_xpos).w,(o_player+obX).w
		move.w	(v_lamp_ypos).w,(o_player+obY).w
		...
		move.w	(v_lamp_bgx).w,(v_bgscreenposx).w
		move.w	(v_lamp_bgy).w,(v_bgscreenposy).w
		move.w	(v_lamp_bg2x).w,(v_bg2screenposx).w
		move.w	(v_lamp_bg2y).w,(v_bg2screenposy).w
		move.w	(v_lamp_bg3x).w,(v_bg3screenposx).w
		move.w	(v_lamp_bg3y).w,(v_bg3screenposy).w
