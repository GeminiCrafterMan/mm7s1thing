...
-- Delete old ROM.
os.remove("s1built.prev.gen")

-- Backup the most recent ROM.
os.rename("s1built.gen", "s1built.prev.gen")

-- Assemble the ROM.
local assemble_result = common.assemble_file("sonic.asm", "s1built.gen", tools.as, "", tools.s1p2bin, improved_dac_driver_compression and "" or " -a", false)
