...
sfx_JumpLand =		SMPS_id(ptr_sndD1)
sfx_Slide =		SMPS_id(ptr_sndD2)
sfx_BusterShot =		SMPS_id(ptr_sndD3)
sfx_Death =		SMPS_id(ptr_sndD4)
sfx_1up =		SMPS_id(ptr_sndD5)
sfx_ChargeStart =		SMPS_id(ptr_sndD6)
sfx_ChargeLoop =		SMPS_id(ptr_sndD7)
