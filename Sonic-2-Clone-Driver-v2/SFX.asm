...
ptr_sndD1:	SMPS_SFX_METADATA	SoundJumpLand, $70, 0
ptr_sndD2:	SMPS_SFX_METADATA	SoundSlide, $70, 0
ptr_sndD3:	SMPS_SFX_METADATA	SoundBusterShot, $70, 0
ptr_sndD4:	SMPS_SFX_METADATA	SoundDeath, $70, 0
ptr_sndD5:	SMPS_SFX_METADATA	Sound1up, $70, 0
ptr_sndD6:	SMPS_SFX_METADATA	SoundChargeStart, $70, 0
ptr_sndD7:	SMPS_SFX_METADATA	SoundChargeLoop, $70, 0
ptr_sndend
...
SoundCF:	include	"Sonic-2-Clone-Driver-v2/SFX/SndCF - Signpost.asm"
		even
SoundJumpLand:	include "Sonic-2-Clone-Driver-v2/SFX/Snd - Jump Land.asm"
		even
SoundSlide:	include	"Sonic-2-Clone-Driver-v2/SFX/Snd - Slide.asm"
		even
SoundBusterShot:	include "Sonic-2-Clone-Driver-v2/SFX/Snd - Buster Shot.asm"
		even
SoundDeath:	include	"Sonic-2-Clone-Driver-v2/SFX/Snd - Death.asm"
		even
Sound1up:	include	"Sonic-2-Clone-Driver-v2/SFX/Snd - 1up.asm"
		even
SoundChargeStart:	include	"Sonic-2-Clone-Driver-v2/SFX/Snd - Charge Start.asm"
		even
SoundChargeLoop:	include	"Sonic-2-Clone-Driver-v2/SFX/Snd - Charge Loop.asm"
		even
